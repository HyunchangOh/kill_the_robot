<template>
  <div id="app">
    ...
    >
      <svg v-if="!isFullscreen" width="20" height="20" viewBox="0 0 24 24">
        <path
          d="M4 10V4h6v2H6v4H4zm10-6h6v6h-2V6h-4V4zM4 14h2v4h4v2H4v-6zm14 4v-4h2v6h-6v-2h4z"
          fill="currentColor"
        />
      </svg>
      <svg v-else width="20" height="20" viewBox="0 0 24 24">
        <path
          d="M10 4v2H8v2H6V4h4zm8 0v4h-2V6h-2V4h4zM6 16h2v2h2v2H6v-4zm10 2v-2h2v4h-4v-2h2z"
          fill="currentColor"
        />
      </svg>
    </button>
  ...
  methods: {
    ...
    toggleFullscreen: async function () {
      try {
        ...
        // Ignore browser-specific fullscreen failures (e.g., blocked request)
      }
